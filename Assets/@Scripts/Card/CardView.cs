...
public class CardView : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    public CardData SourceData => Data;
    ...
    {
        Data = data;
        RuntimeData = CardRuntimeData.FromSource(data);
        ...
        if (_iconImage != null)
        {
            _iconImage.sprite = RuntimeData != null ? RuntimeData.icon : null;
            _iconImage.enabled = _iconImage.sprite != null;
        }

        if (_titleText != null)
            _titleText.text = RuntimeData != null ? RuntimeData.displayName : "";

        if (_costText != null)
        {
            _costText.gameObject.SetActive(!isEnemy);
            _costText.text = RuntimeData != null ? RuntimeData.cost.ToString() : "";
        }
    ...
    public void AddRuntimeDamage(float amount)
    {
        ...
        RuntimeData.AddDamageToDamageEffects(amount);
    }
    ...
    private void RefreshDirectionIcons()
    {
        ...
        foreach (CardDirection dir in RuntimeData.GetAllDirections())
        {
