...
Shader "Vefects/SH_Vefects_URP_Unlit_Flipbook_Pixel_Color_01"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color129 = ( ( ( input.ase_color * float4( _OverallTint.rgb , 0.0 ) ) * float4( hsvTorgb125 , 0.0 ) ) * _Emissive );
				
				float mainTex_alpha48 = tex2DNode45.a;
				float mainTex_VC_alpha52 = input.ase_color.a;
				float opacity61 = ( mainTex_alpha48 * mainTex_VC_alpha52 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = color129.rgb;
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;110;896,0;Inherit;False;Property;_Dst;Dst;7;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=8BF2899DCF6011C562633047267890D58E6F0443